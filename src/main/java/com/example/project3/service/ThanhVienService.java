...
public class ThanhVienService {
    ...
    public ThanhVien login(String email, String password) {
    ...
    @Transactional
    public ThanhVien create(ThanhVienDTO thanhVienDTO){
    ...
    @Transactional
    public ThanhVien update(ThanhVienDTO updatedThanhVienDTO) {
